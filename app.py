...
app = Flask(__name__)
CORS(app, origins=["https://cortex-ashwath.vercel.app", "http://127.0.0.1:5000", "http://localhost:5000"])
...
SEED_TEMPLATES = [
    ...
    {"filename": "academics.md", "content": "## gpa\n## courses\n## test scores\n"},
    {"filename": "awards.md", "content": "## competition wins\n"},
    {"filename": "projects.md", "content": "## projects\n"},
    {"filename": "strategy.md", "content": "## strategy\n"},
    {"filename": "claude_code.md", "content": "## preferences\n"},
    {"filename": "context.md", "content": "## tone rules\n"},
    {"filename": "college.md", "content": "## target\n"},
    {"filename": "deadline.md", "content": "## deadlines\n"},
    {"filename": "finance.md", "content": "## scholarships\n"},
    {"filename": "music.md", "content": "## music\n"},
...
MCP_TOOLS = [
    {
        "name": "get_full_brain",
        "description": "Get ALL brain data across every cluster. Use this when you need comprehensive context about the user — identity, projects, academics, music, strategy, deadlines, everything.",
        "inputSchema": {"type": "object", "properties": {}},
    },
    {
        "name": "get_cluster",
        "description": "Read a specific brain cluster by filename (e.g. 'core.md', 'projects.md', 'music.md'). Use when you need detailed info from one area.",
    ...
    },
    {
        ...
        "description": "Get brain data relevant to a specific topic. Auto-selects the most relevant clusters. Use instead of get_full_brain when you only need one area (e.g. 'music', 'college', 'robotics').",
        "inputSchema": {"type": "object", "properties": {"topic": {"type": "string", "description": "Topic to get context for"}}, "required": ["topic"]},
    },
    {
        "name": "save_to_brain",
        "description": "Append a new memory to a brain cluster. Assign an appropriate tier: core (permanent identity), active (current work/goals), ref (past achievements), temp (short-lived — set expiry). When you notice the user sharing important context about themselves, proactively ask 'Want me to save this to Cortex?' before calling this tool.",
        "inputSchema": {"type": "object", "properties": {"filename": {"type": "string", "description": "Target cluster filename"}, "bullet": {"type": "string", "description": "Fact to save, e.g. '- won first place 2026'"}, "section": {"type": "string", "description": "Target ## section name inside the cluster (e.g. 'gpa', 'deadlines'). Read the cluster first to find section names."}, "tier": {"type": "string", "enum": ["core", "active", "ref", "temp"], "description": "Memory tier"}, "expiry": {"type": "string", "description": "Expiry date YYYY-MM-DD for temp tier"}, "source": {"type": "string", "description": "Source client (claude, perplexity, etc)"}, "rec": {"type": "string", "enum": ["pending", "confirmed"], "description": "Recommendation status. Use 'pending' when saving an AI recommendation. Use 'confirmed' when upgrading a recommendation the user accepted. Omit for normal factual memories."}}, "required": ["filename", "bullet"]},
    },
    {
        "name": "create_cluster",
