...
def get_full_brain(scope: str = "") -> str:
    ...
    life goals/college/deadlines. Empty string returns everything."""
...
def get_context_for_topic(topic: str, scope: str = "") -> str:
    ...
    when you only need info about a specific area (e.g. 'music', 'college apps',
    'robotics'). Scope filters: 'build' or 'strategy'."""
    docs = filter_by_scope(aw_list(), scope)
